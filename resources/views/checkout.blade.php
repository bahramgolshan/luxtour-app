<div class="row mt-5">
    <div class="col-12 col-md-6 offset-md-3">
        ...
        <p>Click the button below and you'll be taken to a <a href="https://stripe.com/en-gb-us"
                target="_blank">stripe</a>
            checkout form where you can enter real credit / debit card details and send me money.</p>

        <p>My purpose is to demonstrate building a <a href="https://laravel.com/docs/9.x/" target="_blank">Laravel</a> /
            <a href="https://stripe.com/en-gb-us" target="_blank">Stripe</a> app in 5 minutes.</p>

        <p>You can check my source code <a href="https://www.rossedlin.com/portfolio/stripe-laravel/code"
